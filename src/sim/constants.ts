...
import type { Era, EraTheme } from './types';
...
export const BUILDING_LOTS: { x: number; z: number; w: number; d: number }[] = [
  { x: -22, z: -22, w: 14, d: 14 },
  { x: 0, z: -22, w: 14, d: 14 },
  { x: 22, z: -22, w: 14, d: 14 },
  { x: -22, z: 0, w: 14, d: 14 },
...
export const ERA_PALETTES: Record<
  Era,
  { buildings: number[]; vehicles: number[]; outfits: number[] }
> = {
  '1945': {
...
export const ERA_THEMES: Record<Era, EraTheme> = {
  '1945': {
    skyColor: 0xc4b59a,
    fogColor: 0xc4b59a,
    fogDensity: 0.012,
...
export const ERA_BUILDING_HEIGHTS: Record<Era, [number, number]> = {
  '1945': [6, 18],
  '1965': [10, 30],
  '1985': [14, 45],
  '2005': [18, 60],
...
export const STOREFRONT_DATA: Record<
  Era,
  { labels: string[]; colors: [number, number][] }
> = {
  '1945': {
...
export const BILLBOARD_DATA: Record<
  Era,
  { texts: string[]; colors: number[] }
> = {
  '1945': {
...
export const VEHICLE_TYPES_BY_ERA = ERAS.map(() => '') as unknown as Record<
  Era,
  string
>;
