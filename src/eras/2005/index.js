...
function menu(g) { box(g, [2.65, 1.16, 0.06], [-1.0, 2.1, -2.46], mat('painted menu wall', 0xb96e4f, { roughness: 0.9 }), 'painted menu wall'); wallSign(g, 'THE DAILY GRIND\nCOFFEE  $1.50   $2.00   $2.50\nTALL   GRANDE   VENTI\nLATTE  $2.25   FRAPPUCCINO  $2.50\nFAIR TRADE  •  ORGANIC', [-1.0, 2.12, -2.42], [1.65, 1.0], { color: '#f4e9cf', border: '#8b765e', font: 'bold 29px Arial' }); wallSign(g, '☕  ESPRESSO\n☕  ICED LATTE\nORGANIC', [0.08, 2.12, -2.42], [0.48, 0.82], { bg: '#292b27', color: '#e7d8b9', border: '#93826b', font: 'bold 27px Arial' }); }
function decor(g) { wallSign(g, 'FREE\nWi-Fi', [2.75, 2.02, -2.46], [0.58, 0.56], { bg: '#c8e2df', color: '#224d55', border: '#386b70', font: 'bold 54px Arial' }); wallSign(g, '@', [2.15, 2.25, -2.46], [0.3, 0.3], { bg: '#ddc5a4', color: '#563d2d', border: '#8c6042', font: 'bold 82px Arial' }); wallSign(g, 'COMMUNITY\nBOARD\nGIGS • EVENTS • ADS', [-2.0, 1.92, 2.46], [1.0, 1.0], { bg: '#b87946', color: '#27211c', border: '#3f2c20', font: 'bold 30px Arial' }); wallSign(g, 'INDIE NIGHT\nLOCAL GIGS\nALL AGES', [1.8, 1.46, 2.46], [0.7, 0.8], { bg: '#d85e46', color: '#fff2dd', border: '#242326', font: 'bold 31px Arial' }); }
